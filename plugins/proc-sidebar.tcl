...
proc BindKeys {} {
    ...
    set key "<Control-x><Key-p>"

    if {[catch { ::Tclme::BindKey proc-sidebar $key $bindtag }]} {
        catch { ::Tclme::BindKey proc-sidebar $key }
    }
    ...
    SetCommandKey proc-sidebar $key
}
...
Tclme::DefCommand proc-sidebar         cmd-toggle  "Toggle Tcl procedure sidebar"
