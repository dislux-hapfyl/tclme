...
# ============================================================================
# Tclme: a small, hackable, event-driven text editor
# ============================================================================
...
# Qualify a command prefix/script according to its owning plugin.
...
# A message meant for the minibuffer. If a prompt is active, do not destroy
# the user's input; put the note in the status line instead.
...
proc Tclme::Invoke {name args} {
    ...
    if {[dict exists $commands $name]} {
        ...
        Tclme::Message "Undefined command: $name"
    }
...
# ============================================================================
#  Minibar / prompt / history / completion
# ============================================================================
...
proc Tclme::MinibarReturn {} {
    ...
    if {[string index $t 0] eq ":"} {
        Tclme::HistoryAdd $t
        .minibar.entry delete 0 end
        Tclme::RunExCommand [string range $t 1 end]
...
proc Tclme::EvalInput {code} {
    ...
    if {[catch {uplevel #0 $code} result]} {
        Tclme::Message "Error: $result"
    } else {
        Tclme::Message "=> $result"
    }
}
...
proc Tclme::Init {} {
    ...
    Tclme::DefCommandAndBind cancel  Tclme::CmdCancel        <Escape>               "Cancel prompt"
    Tclme::DefCommandAndBind goto    Tclme::CmdGoto          <Control-l>            "Goto line"
    Tclme::DefCommandAndBind new     Tclme::CmdNew           <Control-x><Control-space>       "Create a new empty buffer (default scratch)"

    Tclme::DefCommand save-as     Tclme::CmdSaveAs     "Save current buffer to a new path"
    ...
    Tclme::DefCommand scratch     Tclme::CmdScratch "Switch to scratch buffer, creating it if needed"

    Tclme::DefAlias n   new
    Tclme::DefAlias scr scratch
    Tclme::DefAlias w   write
    Tclme::DefAlias q   quit
    Tclme::DefAlias e   edit
